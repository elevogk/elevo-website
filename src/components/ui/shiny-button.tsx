  ...
  return (
    <>
      <style>{`
        ...
        .shiny-cta {
          --shiny-cta-bg: #080B14;
          --shiny-cta-bg-subtle: #1a2a4a;
          --shiny-cta-fg: #ffffff;
          --shiny-cta-highlight: #4A90D9;
          --shiny-cta-highlight-subtle: #7ab4f0;
          ...
          box-shadow: inset 0 0 0 1px var(--shiny-cta-bg-subtle), 0 0 20px rgba(74,144,217,0.3);
          transition: var(--transition);
          transition-property: --gradient-angle-offset, --gradient-percent, --gradient-shine, box-shadow;
        }
        .shiny-cta:hover {
          box-shadow: inset 0 0 0 1px var(--shiny-cta-bg-subtle), 0 0 35px rgba(74,144,217,0.5);
        }
        .shiny-cta::before,
        .shiny-cta::after,
